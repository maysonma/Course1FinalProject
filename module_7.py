...
"""
CARLA waypoint follower assessment client.sh script.
...
def get_current_pose(measurement):
    """Obtains current x,y,yaw pose from the client.sh measurements
    
    Obtains the current x,y, and yaw pose from the client.sh measurements.

    Args:
        measurement: The CARLA client.sh measurements (from read_data())
...
def send_control_command(client, throttle, steer, brake,
    ...
    """Send control command to CARLA client.sh.
    
    Send control command to CARLA client.sh.

    Args:
        client: The CARLA client.sh object
...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        print('Carla client.sh connected.')
